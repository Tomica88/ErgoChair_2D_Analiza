            ...
            <div className="fixed bg-stone-800/50 inset-0 w-screen h-screen flex items-center justify-center z-50">
                <AnimatedContainer delay={0.5} styles="z-50">
                    <div className="relative bg-black px-7 py-3.5 rounded-xl max-w-[600px] min-w-[300px] text-white m-5">
                        <h2 className=''>Vaša naloga je, da si ogledate celotno spletno stran, izberete vrsto stola po želji in nato opravite nakup. &#128221;</h2>
                        <div 
                            onClick={closeWindow} 
                        ...
                        <IoClose 
                            className='w-10 h-10 cursor-pointer absolute top-[5px] right-[8px] px-[7px] py-[5px]'
                            onClick={closeWindow}
                        />
                    </div>
                </AnimatedContainer>
